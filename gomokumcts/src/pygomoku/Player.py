...
from .mcts.MCTS import MCTS, MCTSWithDNN
from .mcts.policy_fn import rollout_policy_fn, MCTS_expand_policy_fn
from .mcts.Networks import SimpleCNN
...
class HumanPlayer(Player):
    ...
    def getActionViaStdin(self, board):
        while True:
            try:
                # Use input() for all Python versions
                next_location = input(
